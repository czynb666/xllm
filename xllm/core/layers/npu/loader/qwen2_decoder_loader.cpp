...
constexpr int kGatedMlpIndex = 4;
...
Qwen2DecoderLoader::Qwen2DecoderLoader() : BaseLoader() {}
...
TransposeType Qwen2DecoderLoader::check_transpose(at::Tensor& tensor) {
